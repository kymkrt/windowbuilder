...
public class T2_Test2 extends JFrame{
	JPanel pn1, pn2, pn3;
	...
	public T2_Test2() {
		...
		lbl1.setIcon(new ImageIcon(T2_Test2.class.getResource("/t22_Swing/images/112.jpg")));
		lbl1.setBounds(40, 10, 145, 291);
		pn2.add(lbl1);
		
		JLabel lbl2 = new JLabel("");
		lbl2.setIcon(new ImageIcon(T2_Test2.class.getResource("/t22_Swing/images/113.jpg")));
